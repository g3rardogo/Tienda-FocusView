...
class Publico
{
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarResponsive">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a href="index.php" class="nav-link" data-toggle="modal">Perfil</a>
                                </li>
                                </li>
                            </ul>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-11">
                                    <input type="email" id="inputEmail" class="form-control" placeholder="Usuario" required
                                        autofocus>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="../private/login.php"> <button href="../private/login.php" type="button"
    ...
    <script src="../../resources/js/jquery.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"> </script>
